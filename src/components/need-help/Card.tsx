...
const Card = ({image,text,header,index}:Props) => {
  return (
        <div className='lg:flex justify-between items-center'>
          <img src={image} className={` md:w-[50%] lg:m-0 m-auto ${(index+1)%2===0?"order-2":''}`} alt="chat support" />
          <div className={`${styles.card} max-w-[524px] m-auto lg:text-start text-center`}>
