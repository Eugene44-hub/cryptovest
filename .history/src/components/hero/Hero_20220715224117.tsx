    ...
    <section>
      <article className={`${styles.container} container px-[24px]`}>
        ...
        <div className='mt-[17px] flex-wrap flex'>
          ...
          <div className='flex w-[344px] m-auto md:order-2 rounded-[25px] mt-[3px] overflow-hidden'>
          ...
          <div className='text-center w-[90%] md:max-w-[626px] mt-[11px] leading-[36px] m-auto'>
