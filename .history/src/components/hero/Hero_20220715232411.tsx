    ...
    <section>
      <article className={`${styles.container} container px-[24px]`}>
        ...
        <div className='mt-[17px] flex-wrap flex'>
          ...
          <figure className='flex w-full justify-end lg:absolute top-0'>
          <img src={liteCoin} className={"w-[20%] md:w-[auto] md:w-[10%]  "} alt="" />
          </figure>
          </div>
         
          <div className='w-full sm:w-[60%] m-auto md:order-2 md:mt-0 mt-[3px] '>
          <div className='flex md:w-[344px] m-auto rounded-[25px]  overflow-hidden'>
          ...
          <div className='text-center w-[90%] lg:mt-[36px] mb-[67px] md:max-w-[626px] mt-[11px] mt-[] leading-[36px] m-auto'>
