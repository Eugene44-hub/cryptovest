    ...
    <section>
      <article className={`${styles.container} container px-[24px]`}>
        ...
        <div className='mt-[17px] flex-wrap flex'>
          ...
          <figure className='flex w-full bg-[blue] justify-end md:absolute top-0'>
          <img src={liteCoin} className={"w-[20%] md:w-[auto] md:w-[10%]  "} alt="" />
          </figure>
          </div>
         
          <div className='w-full relative sm:w-[60%] m-auto md:order-2 md:mt-0 mt-[3px] '>
          ...
          <figure className='w-[20%] left-0 bg-[green] top-[-200%] md:absolute'>
