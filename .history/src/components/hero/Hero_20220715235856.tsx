...
import spotlight from "../../assets/images/hero/spotlight.png"
import styles from "./Hero.module.scss"
const Hero = () => {
  return (
    <section>
      <img src={spotlight} className="absolute" alt="" />
      <article className={`${styles.container} container px-[24px]`}>
        ...
        <div className='mt-[17px] flex-wrap flex'>
          ...
          <div className='text-center w-[90%] lg:mt-[36px] md:mt-[70px] md:mb-[67px] md:max-w-[626px] mt-[11px] mt-[] leading-[36px] m-auto'>
