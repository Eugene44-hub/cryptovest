    ...
    <section>
      <article className={`${styles.container} container px-[24px]`}>
        ...
        <div className='mt-[17px] flex-wrap flex'>
          ...
          <figure className='flex bg-black w-full justify-end'>
          <img src={liteCoin} className={"w-[40%] "} alt="" />
          </figure>
          <div className='w-full md:order-2 md:mt-0 mt-[3px] '>
          <div className='flex w-[344px] m-auto rounded-[25px] mt-[3px] overflow-hidden'>
